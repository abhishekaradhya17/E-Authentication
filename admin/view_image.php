...
<tr>
	  	 ...
	  	 <td><?php echo $tr[0]; ?></td>
	   	 <td><img src="seq_upload/<?php echo $tr[1]; ?>" hight="50" width="50"></td>
	   	 
	
   	<td><a href="delete_seq_image.php? img_id=<?echo $tr[0] ?>" >Delete</a></td>
</tr>
