...
$q="select * from   myimage  where img_id='$img_id'  ";
...
$query1 = "delete  FROM  myimage  where  img_id='$img_id'  ";

	$result1 = mysql_query($query1);


$file_to_delete = "seq_upload/$image_name";
...
echo "<script>window.location.href = 'view_image.php'</script>";
